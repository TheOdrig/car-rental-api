package com.akif.rental.e2e.penalty;
...
class LateReturnPenaltyE2ETest extends E2ETestBase {
    ...
    void shouldCompleteFullLateReturnFlow() throws Exception {
        ...
        eventCaptor.clear();
        ReturnRequest returnRequest = new ReturnRequest("Late return");
    ...
    void shouldWaivePenaltyAndProcessRefund() throws Exception {
        ...
        PenaltyWaiverRequest waiverRequest = new PenaltyWaiverRequest(
                penaltyAmount,
                "Customer complaint - first time late",
                null
        );
