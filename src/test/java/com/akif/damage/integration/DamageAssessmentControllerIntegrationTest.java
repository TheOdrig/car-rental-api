...
class DamageAssessmentControllerIntegrationTest {
    ...
    private Long createDamageReport() throws Exception {
        DamageReportRequest request = new DamageReportRequest(
    ...
    class AssessDamageTests {
        ...
        void shouldAssessDamageSuccessfullyAsAdmin() throws Exception {
            ...
            DamageAssessmentRequest request = new DamageAssessmentRequest(
                    DamageSeverity.MODERATE,
                    DamageCategory.DENT,
    ...
    class UpdateAssessmentTests {
        ...
        void shouldUpdateAssessmentWhenStatusAllows() throws Exception {
            ...
            DamageAssessmentRequest initialRequest = new DamageAssessmentRequest(
                    DamageSeverity.MODERATE,
                    DamageCategory.DENT,
                    new BigDecimal("1000.00"),
                    false,
            ...
            DamageAssessmentRequest updateRequest = new DamageAssessmentRequest(
