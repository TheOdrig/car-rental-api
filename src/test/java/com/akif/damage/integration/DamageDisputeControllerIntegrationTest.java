...
class DamageDisputeControllerIntegrationTest {
    ...
    private Long createAndAssessDamageReport() throws Exception {
        DamageReportRequest reportRequest = new DamageReportRequest(
                "Disputed damage",
                "Side panel",
        ...
        DamageAssessmentRequest assessRequest = new DamageAssessmentRequest(
                DamageSeverity.MODERATE,
                DamageCategory.DENT,
    ...
    class CreateDisputeTests {
        ...
        void shouldCreateDisputeSuccessfullyAsRentalOwner() throws Exception {
            ...
            DamageDisputeRequest request = new DamageDisputeRequest(
