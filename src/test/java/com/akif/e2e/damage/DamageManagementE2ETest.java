...
class DamageManagementE2ETest extends E2ETestBase {
    ...
    class CompleteDamageFlowE2ETests {
        ...
        void shouldCompleteFullDamageLifecycle() throws Exception {
            ...
            RentalRequestDto rentalRequest = TestDataBuilder.createRentalRequest(car.getId());
            ...
            DamageReportRequestDto damageRequest = new DamageReportRequestDto(
            ...
            assertThat(reportedEvents.get(0).getDamageReport().getId()).isEqualTo(damageId);
            ...
            DamageAssessmentRequestDto assessmentRequest = new DamageAssessmentRequestDto(
                    DamageSeverity.MODERATE,
                    DamageCategory.DENT,
            ...
            assertThat(assessedEvents.get(0).getDamageReport().getId()).isEqualTo(damageId);
            ...
            assertThat(disputedEvents.get(0).getDamageReport().getId()).isEqualTo(damageId);
            ...
            assertThat(resolvedEvents.get(0).getDamageReport().getId()).isEqualTo(damageId);
    ...
    class DamageHistoryE2ETests {
        ...
        void shouldTrackDamageHistoryForVehicle() throws Exception {
            ...
            RentalRequestDto rentalRequest1 = TestDataBuilder.createRentalRequest(car.getId());
