...
class DashboardE2ETest extends E2ETestBase {
        ...
        class DashboardSummaryFlowTests {
                ...
                void shouldReturnCorrectCountsAfterCreatingRentalsWithDifferentStatuses() throws Exception {
                        createRentalDirectly(RentalStatus.REQUESTED, LocalDate.now().plusDays(1),
                                        LocalDate.now().plusDays(5));
                        createRentalDirectly(RentalStatus.REQUESTED, LocalDate.now().plusDays(2),
        ...
        class QuickActionFlowTests {
                ...
                void shouldCompleteFullQuickActionFlow() throws Exception {
                        ...
                        MvcResult approveResult = mockMvc
                                        .perform(post("/api/admin/quick-actions/rentals/{id}/approve", rentalId)
                                                        .header("Authorization", "Bearer " + adminToken))
                                        .andExpect(status().isOk())
                        ...
                        MvcResult pickupResult = mockMvc
                                        .perform(post("/api/admin/quick-actions/rentals/{id}/pickup", rentalId)
                                                        .header("Authorization", "Bearer " + adminToken))
                                        .andExpect(status().isOk())
                                        .andExpect(jsonPath("$.success").value(true))
                        ...
                        MvcResult returnResult = mockMvc
                                        .perform(post("/api/admin/quick-actions/rentals/{id}/return", rentalId)
                                                        .header("Authorization", "Bearer " + adminToken))
                                        .andExpect(status().isOk())
                                        .andExpect(jsonPath("$.success").value(true))
        ...
        class FleetStatusFlowTests {
                ...
                void shouldReturnCorrectFleetStatusWithMultipleCarStatuses() throws Exception {
                        Car rentedCar = Car.builder()
                                        ...
                                        .carStatusType(CarStatusType.RENTED)
                                        .isFeatured(false)
