-- =============================================================================
-- V8: Seed Cars (18 vehicles across different classes)
-- =============================================================================
-- Status: AVAILABLE (most), RENTED (2), RESERVED (1), MAINTENANCE (1)
-- =============================================================================
...
INSERT INTO gallery.car (
    ...
    'Diesel', 'Automatic', 'Hatchback', 'Gray', 48000, 5, 5,
    FALSE, TRUE, 78, 19,
